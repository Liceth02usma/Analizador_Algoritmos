...
class TranslationResponse(BaseModel):
    ...
    from_cache: bool = Field(default=False, description="True si fue obtenido de ChromaDB")
...
class NaturalLanguageToPseudocodeAgent(AgentBase[TranslationResponse]):
    ...
    def _init_chroma_db(self):
        ...
        try:
            ...
            print(f"[ChromaDB] ✅ Conectado a colección 'translated_algorithms' en {chroma_db_path}")
    ...
    def _search_in_chroma_db(self, user_input: str) -> Optional[str]:
        ...
        try:
            ...
            results = self.algorithms_collection.query(
                ...
                n_results=1,
                where_document={"$contains": user_input.lower()}  # Búsqueda adicional exacta
            )
    ...
    def _store_in_chroma_db(self, user_input: str, pseudocode: str, algorithm_name: str = ""):
        """
...
"""
    ...
    def _search_known_algorithms(self, user_input: str) -> Optional[str]:
        ...
        for algo in KNOWN_ALGORITHMS:
            ...
            if user_input_lower in keywords or user_input_lower in name or \
               any(kw in user_input_lower for kw in keywords.split(",")):
    ...
    def translate(self, user_input: str) -> TranslationResponse:
        ...
        if response.was_successful and response.pseudocode:
            ...
            algo_name = response.pseudocode.split("(")[0].strip() if "(" in response.pseudocode else "unknown"
