            ...
            if "call" in node_type.lower():
                ...
                if called_func:
                    ...
                    if parent_proc and called_func == parent_proc:
                        ...
                        print(
                            f"🔴 [DEBUG] Recursión directa detectada: {parent_proc} llama a {called_func}"
                        )
                    ...
                    "body": [
                        {
                            ...
                            "end": "n",
                            "body": [
                                {"type": "assign", "lvalue": "temp", "value": "x"}
                            ],
                        }
                    ],
                }
...
def test_merge_sort_recursivo():
    ...
    ast = [
        ...
        },
        {
            ...
            "body": [{"type": "while_loop", "cond": {}, "body": []}],
        },
    ]
    ...
    assert result["algorithm_type"] == "recursivo"
    print(
        f"✅ Merge Sort: {result['algorithm_type'].upper()} (tiene bucles pero la recursión domina)"
    )
