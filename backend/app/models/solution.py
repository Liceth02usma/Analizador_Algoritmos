        ...
        if self.diagrams:
            ...
            if "recursion_trees" in self.diagrams:
                ...
                if hasattr(trees, "trees"):
                    lines.append(
                        f"  Recursion Tree Sketches: {len(trees.trees)} generated"
                    )
